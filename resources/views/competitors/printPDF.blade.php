...
<body>
    <div>
        ...
        <p>Data ir laikas: {{$group->start_date}} {{chop($group->start_time, ":00")}}</p>
        ...
        @endforeach
        <h4>Svėrimas:</h4>
        <p>Data ir laikas: {{$group->weight_date}} {{chop($group->weight_time_from, ":00")}} - {{chop($group->weight_time_to, ":00")}}</p>
