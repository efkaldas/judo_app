...
class CategoriesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('categories.create')->with('judokas', $user);
    }
    ...
    public function update(Request $request, $id, $group, $category)
    {
        ...
        $cat = Category::find($a);
        $category->judokas()->attach($judoka);

        return redirect('/events/{id}/groups/{group}')->with('success', 'Sportininkas užregistruotas!');
    }
